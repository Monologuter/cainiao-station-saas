...
> 上游规格：`docs/superpowers/specs/cainiao-station-platform-design.md`（§5 analytics / §9 横切 / §4.3 事件 / §3 多租户）；UI：`docs/superpowers/specs/cainiao-station-ui-design.md`（§8.1 经营统计页 / §8.2 平台总览）；路线图：`docs/superpowers/plans/全周期实现计划总表.md`（P2-4）。
